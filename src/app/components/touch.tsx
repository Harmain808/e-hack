        ...
        <div className="py-12 text-black mt-12">
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-[720px] h-auto px-4 md:px-12 py-8 flex flex-col justify-between">
              ...
              <div className="my-10">
                <button className="bg-black py-4 px-4 rounded-[5px] text-white">
                  Get in touch
                </button>
              </div>
            </div>
            ...
            <div className="w-full md:w-[890px] h-auto">
              <Image
                ...
                width={800}
                alt="chair"
                className="w-full h-full object-cover transition-transform duration-300 ease-in-out hover:scale-105 hover:rotate-4"
              />
            </div>
          </div>
        </div>
